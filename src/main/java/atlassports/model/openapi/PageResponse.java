...
public class PageResponse<T> {
    ...
    public PageResponse content(List<T> content) {
        this.content = content;
        return this;
    }

    public PageResponse addContentItem(T contentItem) {
    ...
    public PageResponse page(@Nullable Integer page) {
        this.page = page;
        return this;
    }
    ...
    public PageResponse size(@Nullable Integer size) {
        this.size = size;
        return this;
    }
    ...
    public PageResponse totalElements(@Nullable Integer totalElements) {
    ...
    public PageResponse totalPages(@Nullable Integer totalPages) {
    ...
    public PageResponse first(@Nullable Boolean first) {
        this.first = first;
        return this;
    }
    ...
    public PageResponse last(@Nullable Boolean last) {
        this.last = last;
        return this;
    }
